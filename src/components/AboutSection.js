    ...
    <section className="">
      <div className="grid grid-rows-2 grid-cols-12 gap-8 w-screen">
        <div
          ...
          ref={addRefs}
        >
          <div className="block font-mono font-bold text-primary-orange lg:text-2xl md:text-5xl xs:text-3xl mb-8 pl-16 ">
            ABOUT US
          </div>
          <div className="block font-serif font-bold text-gray-800 lg:text-6xl md:text-5xl xs:text-3xl px-16">
            Explore All Corners Of The World With Us
          </div>
        </div>

        <div
          className="md:col-start-7 md:col-end-13 xs:col-span-12 ... bg-primary-orange-100 h-96 p-16 h-auto"
          ref={addRefs}
        >
          <div className="block font-bold text-gray-700 lg:text-2xl md:text-1xl xs:text-1xl mb-8 pl-8">
          ...
          <div className="block font-serif font-bold text-gray-800 lg:text-2xl md:text-2xl xs:text-2xl pl-8">
        ...
        <div className="md:col-start-1 md:col-end-7 xs:col-span-12 ...">
        ...
        <div
          className="md:col-start-7 md:col-end-13 xs:col-span-12 ... bg-sky-blue shadow-lg static"
          ref={addRefs}
        >
